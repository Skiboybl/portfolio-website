      ...
      <Container>
        ...
        <article className="w-75 m-auto pt-2 text-left about-container">
          ...
          <div className="mt-4 pt-2">
            ...
            <strong> {occupation}</strong> focused on Front-End Development. I used <Link to="/resume">FreeCodeCamp</Link> and <Link to="/resume">Udemy Courses</Link> to get started, then applied my knowledge to build my projects.
            <br />
